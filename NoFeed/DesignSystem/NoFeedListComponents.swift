...
//  "add" button — all from the Claude Design spec (NoFeed.dc.html).
//
...
struct NoFeedToggleStyle: ToggleStyle {
...
extension ToggleStyle where Self == NoFeedToggleStyle {
    static var noFeed: NoFeedToggleStyle { NoFeedToggleStyle() }
}
