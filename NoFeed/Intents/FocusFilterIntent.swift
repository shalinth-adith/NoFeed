...
//  records the preferred NoFeed profile to the App Group; the app switches to it
...
struct ApplyFocusProfileIntent: SetFocusFilterIntent {
    static var title: LocalizedStringResource = "NoFeed Focus Profile"
    static var description: IntentDescription? =
        "Switch NoFeed to a focus profile while this Focus is active."
    ...
    var displayRepresentation: DisplayRepresentation {
        if let profileName, !profileName.isEmpty {
            return DisplayRepresentation(title: "NoFeed: \(profileName)")
        }
        return DisplayRepresentation(title: "NoFeed profile")
    }
