...
//  Orb, and frosted glass cards (Claude Design spec, NoFeed.dc.html). All logic,
    ...
    private var permissionCard: some View {
        VStack(spacing: 12) {
            Label("Screen Time access needed", systemImage: "hand.raised.fill")
                ...
                .foregroundStyle(ZTheme.Palette.textPrimary)
            Text("NoFeed needs Screen Time access to block distracting apps during focus.")
                .font(ZTheme.Font.body(13))
