...
//  NoFeed
//
//  Quiet entry screen (Claude Design spec, NoFeed Quiet Entry.dc.html):
...
struct SplashView: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel("NoFeed. A calm and simple way to stay focused.")
