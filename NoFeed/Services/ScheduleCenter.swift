...
//  hands enforcement to the system: NoFeedMonitor.intervalDidStart/End applies and
...
final class ScheduleCenter {
    ...
    func startOneOff(activity: DeviceActivityName,
        ...
        do {
            ...
            print("[NoFeed] startMonitoring (one-off) failed for \(activity.rawValue): \(error)")
        }
    }
    ...
    func startRecurring(activity: DeviceActivityName,
        ...
        do {
            ...
            print("[NoFeed] startMonitoring (recurring) failed for \(activity.rawValue): \(error). " +
