# Zen-ly — TestFlight Manual Test Plan
...
**Steps:**
1. If a previous Zen-ly build is installed and you want to test first-run (§1), **delete it**
...
3. Open **Settings ▸ Notifications ▸ Zen-ly** and make sure notifications are **Allowed** (needed
   for §4, §9).
...
- **Goal:** First screen animates correctly and brands as "Zen-ly".
- **Setup:** App freshly launched (from a cold start — swipe it out of the app switcher first).
- **Steps:**
  1. Tap the Zen-ly icon to launch.
...
- **Expected:** Deep-indigo background. Small distracting-app **chips scatter away**, a focus
  ...
  **"Zen-ly"** and **"Find your focus."** appear, with a "Begin your focus session" line. It then
...
- **Steps:**
  1. Force-quit Zen-ly (swipe up in the app switcher).
  2. Relaunch it and watch the splash.
- **Expected:** You see the settled orb + "Zen-ly / Find your focus." **without** the scatter /
...
- **Steps:**
  ...
  2. Leave Zen-ly and open the blocked app (Instagram).
- **Expected:** Instead of the app, **Zen-ly's custom shield** appears over it.
- **Result:** ⬜ Pass  ⬜ Fail  ⬜ Blocked — **Notes:** ____________________
...
- **Steps:**
  ...
  3. Also try **Phone, Messages, Settings, and Zen-ly**.
- **Expected:** All the normal apps are shielded; **Phone, Messages, Settings, and Zen-ly stay
  usable**.
- **Result:** ⬜ Pass  ⬜ Fail  ⬜ Blocked — **Notes:** ____________________
...
- **Steps:**
  1. Start Focus.
  2. Leave Zen-ly and use other apps for the **full duration** (don't reopen Zen-ly) so iOS
     background-terminates it.
  3. After the duration has passed, reopen Zen-ly.
...
- **Setup:** Zen-ly running (foreground or just backgrounded). A schedule starting within ~60s.
- **Steps:**
...
- **Steps:**
  ...
  2. Bring Zen-ly to the **foreground** (this re-arms the reminder).
...
- **Setup:** iOS **Settings ▸ Notifications ▸ Zen-ly ▸ Allow Notifications = OFF**.
...
- **Steps:**
  1. Long-press the Home Screen → **+** → search **Zen-ly** → add a widget.
...
- **Steps:**
  ...
  2. Authorize in Spotify, then return to Zen-ly.
  3. Use the Focus music row: play / pause / next.
- **Expected:** You return to Zen-ly; **play/pause/next control Spotify**. *(Free account: it may
  connect but controls do nothing — that's expected; mark Blocked.)*
- **Result:** ⬜ Pass  ⬜ Fail  ⬜ Blocked — **Notes:** ____________________

### TC-11.5 Focus filter
- **Goal:** An iOS Focus can switch Zen-ly's profile.
- **Steps:**
  1. iOS **Settings → Focus →** choose a Focus **→ Focus Filters → add Zen-ly**, pick a profile.
  2. Turn that Focus **on**, then open Zen-ly.
- **Expected:** Zen-ly switches to the chosen profile on next open.
- **Result:** ⬜ Pass  ⬜ Fail  ⬜ Blocked — **Notes:** ____________________

### TC-11.6 Permission-denied states
- **Goal:** Denied Calendar/Reminders shows a helpful message, not a dead button.
- **Setup:** In iOS Settings, **deny** Calendar or Reminders for Zen-ly.
- **Steps:** Open the related area in Zen-ly (Settings/Tasks/Calendar card).
...
- **Steps:** Say **"Hey Siri, start a focus session in Zen-ly"** (or run it from the Shortcuts app).
- **Expected:** Zen-ly opens and a session starts using the **active profile**.
- **Result:** ⬜ Pass  ⬜ Fail  ⬜ Blocked — **Notes:** ____________________
...
- **Expected:** Zen-ly opens and starts a session.
- **Result:** ⬜ Pass  ⬜ Fail  ⬜ Blocked — **Notes:** ____________________
...
- **Expected:** Splash announces **"Zen-ly. Find your focus."**; the music buttons announce
