...
//  (NoFeed Quiet.dc.html: "New profile · live", "Saved with nothing entered",
...
struct ProfileEditView: View {
    ...
    private var blockedSaveSheet: some View {
        QuietBlockedSaveSheet(
            ...
            message: "Screen Time access is off, so NoFeed can\u{2019}t hold apps back yet. Everything you typed is kept.",
    ...
    static func domainProblem(_ candidate: String) -> String {
        ...
        return "That isn\u{2019}t a website NoFeed can recognise."
    }
