...
//  glow button (Claude Design spec, NoFeed.dc.html). Logic unchanged.
//
...
struct OnboardingView: View {
        ...
        ZStack {
            ...
            TabView(selection: $step) {
                ...
                infoPage(icon: "timer",
                         ...
                         message: "Start a focus session and NoFeed blocks distracting apps and websites until your timer ends.",
    ...
    private var permissionPage: some View {
        scaffold(icon: "hand.raised.fill",
                 ...
                 message: "NoFeed uses Apple's Screen Time to block distracting apps during focus. Your activity stays private on your device — NoFeed never sees it.") {
            VStack(spacing: 12) {
